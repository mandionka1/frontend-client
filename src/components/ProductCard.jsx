...
const ProductCard = ({
  ...
  return (
    <div className="shadow-md rounded-lg overflow-hidden hover:shadow-lg transition duration-300 bg-white">
      ...
      <div className="p-2 flex flex-col">
        ...
        <p className="text-blue-600 font-bold text-sm mt-2">{price} FCFA</p>
        ...
        <button
          ...
          className="mt-2 w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg transition duration-300"
        >
